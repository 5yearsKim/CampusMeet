...
const slides = [
  {
    ...
    image: Platform.OS == 'android' ?
      ...
      ratio < threshold ?
        ...
        require('assets/images/intro/ios_preview1.png'),
  ...
  },
  {
    ...
    image: Platform.OS === 'android' ?
      ...
      ratio < threshold ?
        ...
        require('assets/images/intro/ios_preview2.png' ),
    backgroundColor: bgcolor,
  },
  {
    key: '3',
    image: Platform.OS === 'android' ?
      ...
      ratio < threshold ?
        ...
        require('assets/images/intro/ios_preview3.png' ),
    backgroundColor: bgcolor,
  },
  {
    key: '4',
    image: Platform.OS === 'android' ?
      ...
      ratio < threshold ?
        ...
        require('assets/images/intro/ios_preview4.png' ),
    backgroundColor: bgcolor,
  },
  {
    key: '5',
    image: Platform.OS === 'android' ?
      ...
      ratio < threshold ?
        ...
        require('assets/images/intro/ios_preview5.png' ),
    backgroundColor: bgcolor,
  },
];
